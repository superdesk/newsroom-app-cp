...
PR_MANAGER_SIDENAV_ENABLED = strtobool(os.environ.get("PR_MANAGER_SIDENAV_ENABLED", is_test_instance))
...
PR_MANAGER_SIDENAV_URL = os.environ.get(
    ...
    "https://stgadmin.prgloo.com/cp" if is_test_instance else "https://admin.prgloo.com/cp",
)
